...
train_pipeline = [
    ...
    dict(
        type='Resize',
        #img_scale=[(2250, 600), (2250, 1500)],
        img_scale=[(2250, 600), (2250, 1400)],
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=[data_root + 'annotations/instances_train2017.json',data_root + 'annotations/instances_train2017.json'],
...
log_level = 'INFO'
work_dir = './work_dirs/tsd_rcnn_r101_ga_dcn'
load_from = None
resume_from = None
workflow = [('train', 1)]
